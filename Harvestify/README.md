...
- **Note:** The master branch doesn't have the updated code used for deployment, to download the updated code used for deployment you can use the following command
  ...
  ```
  ❯ git clone -b deploy https://github.com/stogaja/Harvestify.git
  ```
...
Please read [CONTRIBUTING.md](https://github.com/stogaja/Harvestify/blob/master/CONTRIBUTING.md) for details on our code of conduct, and the process for submitting pull requests to us.
...
#### If you have any doubt or want to contribute feel free to email me or hit me up on [LinkedIn](https://www.linkedin.com/in/stephen-odhiambo-ogaja/)
